...
class SeamCarver:
    ...
    #---Function responsible for carrying out the seams
    def seams(self, n):
        """
        ...
        seams_found = []
        for _ in range(n):
            seam_image = np.zeros((self.image.height, 1),dtype=np.int) 
    ...
    def resize(self, desired_width, desired_height): 
        ...
        elif desired_width > self.image.width: 
        ...
        elif desired_height > self.image.height: 
            self.image.transposed = True
